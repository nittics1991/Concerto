...
class MailCcInf extends ModelDb
{
    ...
    *   @var string
    */
    protected $schema = 'public.mail_cc_inf';
    
    /**
    *   ユーザ情報取得
    *
    *   @param MailCcInfData $obj 検索条件
    *   @param string $order ORDER条件
    *   @return array
    */
    public function getUserList(MailCcInfData $obj, $order = '')
    {
        $sql = "
            SELECT A.*, B.* 
            FROM {$this->name} A 
    ...
    */
    public function getMaxNoSeq(
        ...
        return (isset($result[0]['no_seq'])) ? $result[0]['no_seq'] : 0;
    }
}
