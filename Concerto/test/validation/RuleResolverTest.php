...
{
    public function validate($val, array $inputs)
    {
        return $val < 5;
    }
}
...
//      $this->markTestIncomplete();
        ...
        //function
        $constraint = 'Concerto\test\validation\ruleResolverFunction';
        ...
        //callable
        $constraint = ['Concerto\test\validation\TestCallableConstraint', 'validate'];
        $generated = $this->callPrivateMethod($obj, 'parseCallableRule', ['prop1', $constraint, $dataset]);
        $this->assertEquals(true, method_exists($generated[0], 'isValid'));
        $this->assertEquals(false, ($generated[0])->isValid(10));
