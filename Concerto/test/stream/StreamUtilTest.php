...
namespace Concerto\test\stream;

use Concerto\test\ConcertoTestCase;
use Concerto\stream\StreamUtil;
use Concerto\stream\StreamCallbackFilter;
...
//      $this->markTestIncomplete();
    ...
    */
    public function appendExceptionProvider()
    {
        ...
        return array(
            array(null, 'strtoupper', 'aaa', STREAM_FILTER_ALL),
        );
    }
