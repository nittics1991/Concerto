...
namespace Concerto\test\sql\arrayTable;
...
use Concerto\sql\arrayTable\{
    OnMemoryArrayTable,
    PDOArrayTable
};

class OnMemoryArrayTableTest extends ConcertoTestCase
{
    public $object;
    public $pdo;
    ...
    */
    public function callMagicMethodProvider()
    {
        return [
    ...
    */
    public function createTableSchemaProvider()
    {
        return array_map(
    ...
    */
    public function buildCreateTableSqlProvider()
    {
        return [
            //empty
            [
            ...
            [
                'success1',
                [
                    'prop_b' => OnMemoryArrayTable::TYPE_TEXT,
                    'prop_i' => OnMemoryArrayTable::TYPE_INTEGER,
                    'prop_f' => OnMemoryArrayTable::TYPE_NUMERIC,
                    'prop_s' => OnMemoryArrayTable::TYPE_TEXT,
                    'prop_d' => OnMemoryArrayTable::TYPE_TIMESTAMP,
                    'prop_d2' => OnMemoryArrayTable::TYPE_TIMESTAMP,
                ],
                [
                    'CREATE',
                    'TABLE',
    ...
    */
    public function buildInsertStatementProvider()
    {
        return [
            [
                'DUMMY11',
    ...
    */
    public function doInsertDataProvider()
    {
        return [
            [
                'DUMMY21',
    ...
    */
    public function createTableFromArrayTableSchemaProvider()
    {
        return [
            [
                'DUMMY31',
    ...
    *   @return array [table_name, data, expect]
    */
    public function createTableFromArrayTableProvider()
    {
        return [
            [
                'DUMMY41',
    ...
    */
    public function userSetSchemaProvider()
    {
        return [
            [
                'DUMMY51',
    ...
    */
    public function userSetSchemaUnMatchDataColumnProvider()
    {
        return [
            [
                'DUMMY61',
    ...
    public function userSetSchemaUnMatchDataColumn($name, $schema, $data, $expect)
    {
        ...
        try {
            ...
            if ($expect === null && $e->getCode() === 'HY000') {
                ...
                $this->assertEquals(1, 0, var_export($e, true));
            }
            return;
        }
    ...
    *   @return array [table_name, schema, data, expect]
    */
    public function unMatchDataColumnProvider()
    {
        return [
            [
                'DUMMY61',
