...
//      $this->markTestIncomplete();
        ...
        $object->write(array(date('Ymd His'), 9999, 'エラーメッセージ' . PHP_EOL));
        
        //ログライタ追加
        $object = new Log($writer);
        $object->addWriter($writer2);
        $object->write(array(
                array('エラーメッセージ2' . PHP_EOL),
                array(date('Ymd His'), 9999, 'エラーメッセージ2' . PHP_EOL)
            ));
...
//      $this->markTestIncomplete();
    ...
    public function obj2strProvider()
    {
        $stub = $this
    ...
    /**
    *   @test
    *   @dataProvider obj2strProvider
    **/
    public function obj2str($data, $expect)
    {
//      $this->markTestIncomplete();
        ...
        $object = new Log($stub);
        $this->assertEquals($expect, $this->callPrivateMethod($object, 'obj2str', [$data]));
    }
