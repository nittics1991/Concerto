...
//      $this->markTestIncomplete();
        ...
        return array(
            array(
                ...
                '1', '20150116 123456', 'symphony', 'FIX9999', '手配詳細'
            )
        );
    }
...
//      $this->markTestIncomplete();
        ...
        $this->class->fg_kanjyo = $fg_kanjyo;
        ...
        //$this->assertTrue($this->class->isValidYn_ryohi($yn_ryohi));
        ...
        $this->assertTrue($this->class->isValidFg_kanjyo($fg_kanjyo));
...
//      $this->markTestIncomplete();
        ...
        return array(
            array(
                ...
                '10000', '420', '3000', '担当名', '商品',
                '5', 'ICC', 'ZICD00253', '21',
                'Z', '20150239 123456', 111, 'FIX9999', '手配詳細'
            )
        );
    }
...
//      $this->markTestIncomplete();
        ...
        //$this->assertFalse($this->class->isValidYn_ryohi($yn_ryohi));
        ...
        $this->assertFalse($this->class->isValidFg_kanjyo($fg_kanjyo));
