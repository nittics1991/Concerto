...
//      $this->markTestIncomplete();
        ...
        $str    = 'AB&C"DE"F&G';
        $ar         = array('fast&1', array('2nd&x', '3rd"%$&"xx'));
        $int    = 1234;
        $bool   = true;
        
        $expect = array($str, $ar, $int, $bool);
...
//      $this->markTestIncomplete();
        ...
        $this->assertEquals(mb_convert_encoding($int, 'SJIS', 'UTF8'), $this->class->int);
        $this->assertEquals(mb_convert_encoding($bool, 'SJIS', 'UTF8'), $this->class->bool);
...
//      $this->markTestIncomplete();
        ...
        $obj->addHelper('url', new FullUrl());
        $obj->addHelper('pattern', new HtmlPattern());
        
        $this->assertEquals('^20\d{6}$', $obj->pattern('Ymd'));
        $this->assertEquals('http://itc.co.jp:8080/test/index.php', $obj->url('index.php'));
    }
}
