...
use Concerto\filesystem\WorkDir;
...
//      $this->markTestIncomplete();
        ...
        $object->clear();
        $this->assertFileNotExists($dirname . '/tmp/b1/b1b/b1ba');
        $this->assertFileNotExists($dirname . '/tmp/b1/b1b');
        $this->assertFileNotExists($dirname . '/tmp/b1');
...
//      $this->markTestIncomplete();
        ...
        $object->delete();
        $this->assertFileNotExists($dirname . '/tmp');
    }
...
//      $this->markTestIncomplete();
        ...
        $this->assertFileNotExists($dirname . '/tmp/a1');
        $this->assertFileExists($dirname . '/tmp/b1/b1b');  //do not delete DIR
        $this->assertFileNotExists($dirname . '/tmp/c1');
