...
<option value="<?= $list['cd_bumon']; ?>" <?php if ($list['cd_bumon'] == $cd_bumon) {echo'selected';} ?>><?= $list['nm_bumon']; ?></option>
<?php endforeach; ?>
...
<option value="<?= $list['kb_nendo']; ?>" <?php if ($list['kb_nendo'] == $kb_nendo) {echo 'selected';} ?>><?= $list['nm_nendo']; ?></option>
<?php endforeach; ?>
...
<table id="monthly-info">
    ...
    <?php $i=0; ?>
    <?php foreach ($cyokka_mon_list as $list): ?>
    <?php $i++; ?>
    <tr>
        <th><?= $list['dt_month']; ?>
