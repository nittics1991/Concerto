...
class MbEncodeFilter extends php_user_filter
{
    ...
    *   @var string[]
    */
    private array $exclude_encodes = [
        'qprint', 'base64', 'uuencode', 'html-entities',
        'quoted-printable',
    ];
    ...
    *   @var string|int|null
    */
    private string|int|null $prev_mb_substitute_character;
    ...
    */
    public function onCreate():bool
    {
        ...
        $filters = array_filter(
            ...
            function($endode) {
                return !in_array(
                    mb_strtolower($endode),
                    $this->exclude_encodes,
                );
            },
        );

        $aliases = array_map('mb_encoding_aliases', $filters);
