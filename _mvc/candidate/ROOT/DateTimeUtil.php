...
final class DateTimeUtil
{
    ...
    */
    public static function periodDate(
        ...
        $decision = (is_null($dateTime)) ?
            clone $e : clone $dateTime;
    ...
    *   @return string
    */
    public static function YYYYMMDDaddSlash(
        string $val
    ): string {
        if (mb_strlen($val) !== 8) {
            return $val;
    ...
    *   @return string
    */
    public static function YYYYMMDDaddHyphen(
        string $val
    ): string {
        if (mb_strlen($val) !== 8) {
            return $val;
