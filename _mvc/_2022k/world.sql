...
DROP TYPE BoolEnum CASCADE;
DROP TYPE ContinentEnum CASCADE;
...
CREATE TYPE BoolEnum AS ENUM(
    'T','F'
);

CREATE TABLE country (
  Code varchar(3) PRIMARY KEY DEFAULT '',
  Name varchar(52) NOT NULL DEFAULT '',
  Continent ContinentEnum  NOT NULL DEFAULT 'Asia',
...
CREATE TABLE countrylanguage (
  ...
  IsOfficial BoolEnum NOT NULL DEFAULT 'F',
...
INSERT INTO country VALUES ('CHN','China','Asia','Eastern Asia',9572900.00,-1523,1277558000,71.4,982268.00,917719.00,'Zhongquo',E'People''sRepublic','Jiang Zemin',1891,'CN');
