...
use dev\array\ArrayUtilTrait;

class ArrayUtilTraitTest extends ConcertoTestCase
{
...
//      $this->markTestIncomplete("--- markTestIncomplete ---");
    ...
    public function flatRowProvider()
    {
        return [
            //数値キー
            [
