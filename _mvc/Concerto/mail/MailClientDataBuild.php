...
class MailClientDataBuild
{
    ...
    */
    ...
    {
        $this->takeover_data['id'] =
            serialize($this->mail_condition);
    }
    ...
    protected function setAddress(): void
    {
        ...
        switch ($this->config['type']) {
            case 'return':
                ...
                $this->takeover_data['to'] =
                    $first_mail_data->from_adr;
    ...
    */
    protected function setCcAddAddress(): void
    {
        ...
        $globalSession = $this->factory->getSession(true);
    ...
    */
    protected function setSubject(): void
    {
        if (
            ...
            !file_exists(strval($this->config['subject']))
        ) {
            return;
        }
        ...
        $this->takeover_data['subject'] =
            $view->cache(strval($this->config['subject']));
    }
    ...
    */
    protected function setMessage(): void
    {
        if (
            ...
            !file_exists(strval($this->config['message']))
        ) {
            return;
        }
        ...
        $this->takeover_data['message'] =
            $view->cache(strval($this->config['message']));
    }
    ...
    */
    protected function setAfter(): void
    {
        if (
            ...
            file_exists(strval($this->config['after']))
        ) {
