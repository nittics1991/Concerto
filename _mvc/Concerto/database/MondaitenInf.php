...
class MondaitenInf extends ModelDb
{
    ...
    *   @inheritDoc
    */
    protected string $schema = 'public.mondaiten_inf';
    ...
    */
    public function getByCyuban(
        ...
        $sql = "
            SELECT A.*
                , B. cd_yoin AS cd_bunrui3
                , B. nm_yoin AS nm_bunrui3
                , C. no_bunrui2 AS cd_bunrui2
                , C. nm_bunrui AS nm_bunrui2
                , D. no_bunrui AS cd_bunrui1
                , D. nm_bunrui AS nm_bunrui1
            FROM 
                (SELECT *
                FROM {$this->name}
                WHERE (no_cyu = :cyuban
