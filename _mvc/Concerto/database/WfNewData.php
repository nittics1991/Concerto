...
class WfNewData extends ModelData
{
    ...
    *   @var array
    */
    protected static $real_only_properties = [
    ...
    *   @var array
    */
    protected static $plan_only_properties = [
        'dt_hatuban_p',
    ];
    ...
    */
    ...
    public function isValidNo_tm_wt($val)
    {
        if (is_null($val)) {
            return true;
        }
    ...
    public function isValidNo_zanken_s($val)
    {
        if (is_null($val)) {
            return true;
        }
    ...
    public function isValidNo_zanken_g($val)
    {
        if (is_null($val)) {
            return true;
        }
    ...
    public function isValidNo_siteki_s($val)
    {
        if (is_null($val)) {
            return true;
        }
    ...
    public function isValidNo_siteki_g($val)
    {
        if (is_null($val)) {
            return true;
        }
    ...
    public function isValidNm_fg_fuyo($val)
    {
        if (is_null($val) || ($val == '')) {
            return true;
        }
    ...
    public function isValidNm_caution($val)
    {
        if (is_null($val) || ($val == '')) {
            return true;
        }
