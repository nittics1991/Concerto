...
class Server
{
    ...
    *   @return string[]
    **/
    protected static function convertVariableName(): array
    {
    ...
    */
    public static function isAjax(): bool
    {
        ...
        return isset($data['http_x_requested_with']) &&
            strtolower(
                (string)$data['http_x_requested_with']
            ) === 'xmlhttprequest';
    }
    ...
    *   @return string
    */
    public static function getRequestSelfUrl(): string
    {
        $data = self::convertVariableName();
    ...
    *   @return string
    */
    public static function getRequestParentUrl(): string
    {
        $data = self::convertVariableName();
    ...
    */
    public static function getRequestMainUrl(): string
    {
        $data = self::convertVariableName();
