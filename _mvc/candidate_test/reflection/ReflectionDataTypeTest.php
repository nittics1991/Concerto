...
namespace candidate_test\reflection;

use PHPUnit\Framework\TestCase;
use test\Concerto\PrivateTestTrait;
use candidate\reflection\ReflectionDataType;
use ArrayObject;
use Countable;
use DateTime;
use ReflectionClass;
use ReflectionType;
use stdClass;
use candidate_test\reflection\tester\{
...
class ReflectionDataTypeTest extends TestCase
{
    ...
    protected mixed $tester1;
    protected mixed $tester2;
    protected mixed $tester11;
        ...
        return [
            ...
            [
                $this->tester1->getProperty('namespace_tester1')
                    ->getType(),
                [
                    'candidate_test\\reflection\\tester\\' .
                    ReflectionDataTypeTester1::class
                ],
            ],
        ];
