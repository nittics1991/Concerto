...
//      $this->markTestIncomplete();
        ...
        //on条件なし
        $actual = StubArrayUtil::joinTable($ar1, $ar2, [], 'LEFT', '_');
        $expect = [
        ...
        $actual = StubArrayUtil::joinTable($ar1, $ar2, [], 'LEFT');
        $expect = [
            [1, '0401', 103, 101, 'AA'],
            [1, '0401', 103, 102, 'BB'],
            [1, '0401', 103, 103, 'CC'],
        ...
        //innerでjoinしても同じ
        $actual = StubArrayUtil::joinTable($ar1, $ar2, [], 'inner');
        $this->assertEquals($expect, $actual);

        //on条件付加
        $actual = StubArrayUtil::joinTable($ar1, $ar2, [[2, 0]], 'left');
        $expect = [
            [1, '0401', 103, 103, 'CC'],
            [2, '0402', 101, 101, 'AA'],
            [3, '0403', 101, 101, 'AA'],
        ...
        $actual = StubArrayUtil::joinTable($ar1, $ar2, [[2, 0]], 'inner');
        $expect = [
            [1, '0401', 103, 103, 'CC'],
            [2, '0402', 101, 101, 'AA'],
            [3, '0403', 101, 101, 'AA'],
...
//      $this->markTestIncomplete();
        ...
        $this->assertEquals($expect, StubArrayUtil::mergeKeepKey($x, $y));
    }
}
