...
class TempFileArrayTableTest extends ConcertoTestCase
{
    public $object;
    public $pdo;
    ...
    public function buildCreateTableSqlProvider()
    {
        return [
            ...
            [
                'success1',
                [
                    'prop_b' => TempFileArrayTable::TYPE_TEXT,
                    'prop_i' => TempFileArrayTable::TYPE_INTEGER,
                    'prop_f' => TempFileArrayTable::TYPE_NUMERIC,
                    'prop_s' => TempFileArrayTable::TYPE_TEXT,
                    'prop_d' => TempFileArrayTable::TYPE_TIMESTAMP,
                    'prop_d2' => TempFileArrayTable::TYPE_TIMESTAMP,
                ],
                [
                    'CREATE',
                    'TABLE',
