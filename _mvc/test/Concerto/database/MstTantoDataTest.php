...
//      $this->markTestIncomplete('--- markTestIncomplete ---');
        ...
        $this->class->kengen = $kengen;
        $this->class->kengen_db = $kengen_db;
        $this->class->kengen_sm = $kengen_sm;
        ...
        $this->assertEquals($kengen, $this->class->kengen);
        $this->assertEquals($kengen_db, $this->class->kengen_db);
        $this->assertEquals($kengen_sm, $this->class->kengen_sm);
        $this->assertEquals($cd_bumon, $this->class->cd_bumon);
        $this->assertEquals($password, $this->class->password);
        ...
        $this->assertTrue(isset($this->class->kengen));
        $this->assertTrue(isset($this->class->kengen_db));
        $this->assertTrue(isset($this->class->kengen_sm));
        $this->assertTrue(isset($this->class->cd_bumon));
        $this->assertTrue(isset($this->class->password));
...
//      $this->markTestIncomplete('--- markTestIncomplete ---');
        ...
        $this->assertTrue($this->class->isValidKengen($kengen));
        $this->assertTrue($this->class->isValidKengen_db($kengen_db));
        $this->assertTrue($this->class->isValidKengen_sm($kengen_sm));
