...
class FiscalYearTest2 extends ConcertoTestCase
{
    ...
    public function isFirstHalfCodeProvider()
    {
        return [
            [
                '2000K',
    ...
    */
    ...
    public function isLastHalfCodeProvider()
    {
        return [
            [
                '2000K',
    ...
    */
    ...
    public function isHalfCodeProvider()
    {
        return [
            [
                '2000K',
    ...
    */
    ...
    public function inFirstHalfProvider()
    {
        return [
            [
    ...
    */
    ...
    public function inLastHalfProvider()
    {
        return [
            [
                new DateTimeImmutable('2020-10-1 today'),
    ...
    */
    ...
    public function parseCodeProvider()
    {
        return [
            [
                2000,
    ...
    */
    ...
    public function datetimeToCodeProvider()
    {
        return [
            [
                new DateTimeImmutable('2020-4-1 today'),
    ...
    */
    ...
    public function codeToDatetimeProvider()
    {
        return [
            [
                '2020K',
    ...
    */
    ...
    public function datetimeInPeriodProvider()
    {
        return [
            [
                new DateTimeImmutable('2020-4-1 today'),
    ...
    */
    ...
    public function codeInPeriodProvider()
    {
        return [
            [
                '2000K',
    ...
    */
    ...
    public function formattedPeriodProvider()
    {
        return [
            [
                'Ymd',
