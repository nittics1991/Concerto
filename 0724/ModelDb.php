...
class ModelDb implements DataMapperInterface
{
    ...
    *   @return array ModelData 結果セットクラス
    ...
    *   INSERT
    *
    *   @param array $dataset 保存値 [ModelData1, ModelData2, ...]
    *   @throws InvalidArgumentException
    */
    ...
    */
    protected function isValidOrderClause(
        ...
        return $this->isValidClause($template, $clause, $this->order_clause);
    }
    ...
    */
    protected function isValidAggClause(
        ...
        $haystack = array_merge($this->window_clause, $this->agg_function);
